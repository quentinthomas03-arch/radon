...
export const CONFIG_CSP = {
  ...
  // ── ONGLET ENTRÉE (champs essentiels terrain) ─────────────
  entree: {
    sections: [
      {
        id: 'mission',
        ...
        fields: [
          {
            id: 'etab_nom',
            label: "Nom du client / établissement",
            type: 'text',
            required: true,
            excelCell: 'F16',
          },
          ...
          },
          {
            ...
            required: true,
            excelCell: 'C13',
            hint: 'Ex : 14/01/2025 ; 14/04/2025',
          },
          {
            id: 'nb_dosimetres_prevu',
            label: "Nombre de dosimètres (stratégie)",
            type: 'number',
            required: true,
            excelCell: null,
          },
          {
            id: 'nb_plans',
            label: 'Nombre de plans de bâtiment',
            type: 'number',
            required: false,
            excelCell: null,
            hint: 'Génère les onglets de plans correspondants',
            default: 1,
          },
        ],
      },
  ...
  // ── TABLEAU — Hiérarchie : Bâtiment > Zone Homogène > Point ─
  tableau: {
    ...
    point: {
      ...
      fields: [
        ...
        { id: 'dosimetre_perdu',label: 'Dosimètre perdu ou détérioré',           type: 'select', required: false, excelCol: 'S', phase: 'resultats',
          options: ['NON','OUI'] },
  ...
  export: {
    ...
    sheets: {
      entree:  { name: 'Entrée'  },
      tableau: { name: 'Tableau', startRow: 2 },
    },
  },
};
