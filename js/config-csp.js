...
// Champs identiques à la macro HCBD CSP V20/V21
// ============================================================
...
export const CONFIG_CSP = {
  ...
  entree: {
    sections: [
      ...
      },
      {
        ...
        collapsible: true,
        fields: [
          { id: 'date_envoi_initial',   label: "Date d'envoi du rapport de dépistage initial",   type: 'date',   required: false, excelCell: 'C8' },
          { id: 'resultat_initial',     label: 'Résultat du dépistage initial',                  type: 'select', required: false, excelCell: 'C9',
            options: [
          ...
          { id: 'date_interv_initial',  label: "Date d'intervention du dépistage initial",       type: 'text',   required: false, excelCell: 'C10', hint: 'Ex : 25/01/2024 ; 03/04/2024' },
          { id: 'chrono_initial',       label: 'N° de Chrono du dépistage initial',              type: 'text',   required: false, excelCell: 'C11' },
        ]
      },
      {
        id: 'adresse_agence',
      ...
      },
      {
        ...
        fields: [
          ...
          { id: 'etab_adr1',    label: 'Adresse (1)',              type: 'text', required: false, excelCell: 'F17' },
          { id: 'etab_adr2',    label: 'Adresse (2)',              type: 'text', required: false, excelCell: 'F18' },
          { id: 'etab_adr3',    label: 'Adresse (3)',              type: 'text', required: false, excelCell: 'F19' },
          { id: 'etab_cp',      label: 'Code Postal',              type: 'text', required: false, excelCell: 'F20' },
          { id: 'etab_commune', label: 'Commune',                  type: 'text', required: false, excelCell: 'F21' },
          { id: 'etab_email',   label: 'E-mail',                   type: 'email',required: false, excelCell: 'F22' },
          { id: 'etab_tel',     label: 'Tél',                      type: 'tel',  required: false, excelCell: 'F23' },
        ]
      },
      {
        id: 'autres',
  ...
  tableau: {
    ...
    batiment: {
      ...
      fields: [
        ...
        // Hors grille "Tableau" de la macro (pas de colonne dédiée) — utilisé uniquement
        // par la "Fiche de prélèvement par bâtiment".
    ...
    point: {
      ...
      fields: [
        ...
        { id: 'num_dosimetrie',    label: 'N° Dosimétrie',                              type: 'text',   required: true,  excelCol: 'AA', phase: 'terrain', numeric: true },
  ...
  ecarts_normes: [
    ...
    },
    {
      ...
      template: "Non-conformité à la norme NF ISO 11 665-8 : à la demande du client, la stratégie de prélèvement établie n'a pas pu être réalisée dans son entièreté. L'une des zones homogènes déterminée n'a pas pu être investiguée en raison de …",
    },
  ],
