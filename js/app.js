...
function bindEntreeEvents() {
  ...
  // Navigation par onglets : gérée par bindGlobalNav() (délégation globale, cf. plus bas),
  // qui déclenche déjà la sauvegarde auto (clic sur #btn-save-entree) avant de naviguer.
  // Un second listener local ici causait une double sauvegarde + un double rendu de vue.
